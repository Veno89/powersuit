...
PRIMARY_GRIP = Vector((0.0, -0.040, 0.000))
SUPPORT_GRIP = Vector((0.0, 0.205, -0.030))
SUPPORT_GRIP_MIN = Vector((0.0, 0.165, -0.030))
SUPPORT_GRIP_MAX = Vector((0.0, 0.245, -0.030))
STOCK_LATERAL_OFFSET = 0.110
STOCK_CONTACT = Vector((STOCK_LATERAL_OFFSET, -0.365, 0.125))
...
def build_rifle() -> bpy.types.Object:
    ...
    p.append(create_box("Rifle_SupportGrip_Mount", (0.0, 0.205, 0.050),
        (0.060, 0.055, 0.018), material=materials["edge"],
        bevel=SMALL_BEVEL, collection=collection))
    p.append(create_tapered_box("Rifle_SupportGrip", (0.0, 0.205, -0.022),
        (0.060, 0.066, 0.135), front_scale=(0.82, 0.76),
    ...
    p.append(create_cylinder("Rifle_StockSpine", (0.018, -0.190, 0.135),
        radius=0.022, length=0.22, material=materials["body"], collection=collection))
    for side in (-1.0, 1.0):
        p.append(create_tapered_box(
            f"Rifle_StockStrut_{'R' if side < 0 else 'L'}",
            (0.042 + side * 0.045, -0.235, 0.100), (0.028, 0.22, 0.045),
            front_scale=(0.92, 0.70), material=materials["armor"],
            rotation=(math.radians(-9), 0, 0), bevel=SECONDARY_BEVEL,
            collection=collection))
    p.append(create_tapered_box("Rifle_Stock_TopRail", (0.040, -0.235, 0.205),
        (0.105, 0.20, 0.042), front_scale=(0.78, 0.72),
        material=materials["grip"], bevel=SECONDARY_BEVEL, collection=collection))
    p.append(create_tapered_box("Rifle_Stock_BottomRail", (0.048, -0.250, 0.055),
        (0.090, 0.17, 0.032), front_scale=(0.72, 0.70),
        material=materials["armor"], rotation=(math.radians(5), 0, 0),
        bevel=SECONDARY_BEVEL, collection=collection))
    p.append(create_box("Rifle_Stock_RearBridge", (STOCK_LATERAL_OFFSET, -0.335, 0.125),
        (0.112, 0.028, 0.142), material=materials["armor"],
        bevel=SECONDARY_BEVEL, collection=collection))
    p.append(create_tapered_box("Rifle_Stock_ButtPad", (STOCK_LATERAL_OFFSET, -0.350, 0.125),
    ...
    helpers = [
        create_helper("Rifle_PrimaryGrip", PRIMARY_GRIP,
            Vector((0.0, 0.40, -0.916)), Vector((0.0, 1.0, 0.0)), collection),
