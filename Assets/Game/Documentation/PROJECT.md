...
`ArtSource/PoweredSuitNextGen/` contains the original **Aegis Vanguard** studies plus new adult gritty industrial-gothic front/rear targets and deterministic Candidate004: soot-black/carbon/tarnished-chrome materials, structural gothic ribs/gorget, layered pauldrons, recessed outboard turbines, armored gloves/boots, 13 neutral/detail/real-action renders, integrity evidence, and a production/approval lane for a future high-fidelity suit. It is isolated art review, not a runtime replacement. Generator114 and every active Unity model/prefab contract remain unchanged.

Candidate004 proves the existing 23-bone/24-action contract and exact turbine/boot exhaust anchors can be retained. The new 24-action/162-keyframe clearance gate and HeroV2 topology/UV/renderer/LOD gate are operational, but Candidate004 honestly fails them: 7,837 forbidden weapon/suit instances across 304 pairs, plus 25 production errors/16 warnings from missing UV0, 348 n-gons, 80 boundary edges on the four baked cable meshes, 254 renderers/draw calls, and no continuous skinned undersuit. Draft LOD ratios are generated but not approved. Promotion remains blocked pending clearance, retopology, deformation, PBR, consolidation, Unity/performance, and owner A/B approval.
